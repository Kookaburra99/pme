...
def get_node2vec_embeddings(graph: nx.Graph, win_size: int, emb_size: int,
    ...
    """
    Train DeepWalk graph embeddings and return
    ...
    :param p: Return parameter (1/p transition probability) to move towards from previous node
    :param q: In-out parameter (1/q transition probability) to move away from previous node
    ...
    dict_embeddings = {}
    np_embeddings = node2vec.get_embedding()
