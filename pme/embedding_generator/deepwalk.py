...
def get_deepwalk_embeddings(graph: nx.Graph, win_size: int, emb_size: int,
    ...
    """
    start_time = time()
    deepwalk = DeepWalk(walk_number=walk_number, walk_length=walk_length,
    ...
    dict_embeddings = {}
    np_embeddings = deepwalk.get_embedding()
